			...
			<div class="intro_box">
				...
				<div>
					...
					<div class="cointent_step_box">
						...
						<p> Create your <a  target="_blank" href="https://cointent.com/p/account">publisher account</a>, then fill in the plugin info in "General Settings" section below.</p>
					</div>
					<div class="cointent_step_box">
					...
					<div class="cointent_step_box">
						...
						<p>Post your articles, videos, or content! You can setup subscriptions and set prices on <a target="_blank" href="//cointent.com/p/account">cointent.com</a>.</p>
			...
			<form action="options.php" method="post" id="cointent-conf">
								...
								<table class="cointent_main_table">
									...
									<tr>
										...
										<td class="top" >
											<h2>Options</h2>
											<dl>
												<dt class="bold">article_title</dt> <dd>This title will be inlcuded in the purchase verification email sent to customers.<br>The default is the title of your Wordpress post</dd>
												<dt class="bold">title </dt> <dd>The title of the message to the reader. It is shown above the purchase buttons. <br>For default sefault: See "Message Above Purchase Button" in the "Widget and Popup Customization" section</dd>
												<dt class="bold">subtitle</dt> <dd>The subtitle of the message to the reader. It is shown above the purchase buttons. <br>For default see "Message Above Purchase Button" in the "Widget and Popup Customization" section</dd>
												<dt class="bold">post_purchase_title</dt> <dd>This replaces the 'title' field after the reader purchases.</dd>
												<dt class="bold">post_purchase_subtitle </dt> <dd>This replaces the 'subtitle' field after the reader purchases.</dd>
												<dt class="bold">view_type </dt><dd>This overrides the view type option <br>For default see "View Type" in the "Widget and Popup Customization" section</dd>
											</dl>
										</td>
										<td  class="top" >
				...
				<div class="ct-section">
					<div class="body">
						<div class="postbox">
							<div class="ct_postbox_header">
								<h3><?php _e('Pre-purchase View') ?></h3>
								<div class="submit-button">
									<?php submit_button(); ?>
								</div>
							...
							<div class="ct_postbox_body">
								<table class="cointent_main_table">
									<tr>
										<td>
											<h4><?php _e('Word Count, (priority 3)', 'cointent') ?> </h4>
											<p>
								...
								<table class="cointent_main_table">
									...
									<tr>
										...
										<tr>
											...
											<td colspan="2">
												<p>You can add a header image and background to the purchase popup. Please visit the <a target="_blank" href="https://cointent.com/p/account">account page</a> to setup.</p>
